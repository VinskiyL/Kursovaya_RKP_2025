...
public class ReaderUpdateDTO {
    ...
    @Size(max = 100, message = "Профессия должна быть до 100 символов")
    private String profession;

    @Size(max = 200, message = "Учебное заведение должно быть до 200 символов")
    ...
    @Size(max = 10, message = "Корпус должен быть до 10 символов")
